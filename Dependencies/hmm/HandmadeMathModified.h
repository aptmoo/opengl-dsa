/**
 * @file HandmadeMath.h
 * @author Not me, see bottom
 * @brief Handmademath, edited to make it look neater.
 * Original header is placed at the bottom.
 * TODO: Cleanup
 * @version 0.1
 * @date 2023-07-19
 * 
...
#ifdef __cplusplus
    inline Vector2 &operator[](const int &Index)
    {
...
#ifdef __cplusplus
    inline Vector3 &operator[](const int &Index)
    {
        return Columns[Index];
    }
#endif
...
COVERAGE(V4V, 1)
static inline Vector4 V4V(Vector3 Vector, float W)
{
    ASSERT_COVERED(V4V);
...
COVERAGE(AddV2, 1)
static inline Vector2 AddV2(Vector2 Left, Vector2 Right)
{
...
COVERAGE(AddV3, 1)
static inline Vector3 AddV3(Vector3 Left, Vector3 Right)
{
...
COVERAGE(AddV4, 1)
static inline Vector4 AddV4(Vector4 Left, Vector4 Right)
{
...
COVERAGE(SubV2, 1)
static inline Vector2 SubV2(Vector2 Left, Vector2 Right)
{
...
COVERAGE(SubV3, 1)
static inline Vector3 SubV3(Vector3 Left, Vector3 Right)
{
...
COVERAGE(SubV4, 1)
static inline Vector4 SubV4(Vector4 Left, Vector4 Right)
{
...
COVERAGE(MulV2, 1)
static inline Vector2 MulV2(Vector2 Left, Vector2 Right)
{
...
COVERAGE(MulV2F, 1)
static inline Vector2 MulV2F(Vector2 Left, float Right)
{
...
COVERAGE(MulV3, 1)
static inline Vector3 MulV3(Vector3 Left, Vector3 Right)
{
...
COVERAGE(MulV3F, 1)
static inline Vector3 MulV3F(Vector3 Left, float Right)
{
...
COVERAGE(MulV4, 1)
static inline Vector4 MulV4(Vector4 Left, Vector4 Right)
{
...
COVERAGE(MulV4F, 1)
static inline Vector4 MulV4F(Vector4 Left, float Right)
{
...
COVERAGE(DivV2, 1)
static inline Vector2 DivV2(Vector2 Left, Vector2 Right)
{
...
COVERAGE(DivV2F, 1)
static inline Vector2 DivV2F(Vector2 Left, float Right)
{
...
COVERAGE(DivV3, 1)
static inline Vector3 DivV3(Vector3 Left, Vector3 Right)
{
...
COVERAGE(DivV3F, 1)
static inline Vector3 DivV3F(Vector3 Left, float Right)
{
...
COVERAGE(DivV4, 1)
static inline Vector4 DivV4(Vector4 Left, Vector4 Right)
{
...
COVERAGE(DivV4F, 1)
static inline Vector4 DivV4F(Vector4 Left, float Right)
{
...
COVERAGE(EqV2, 1)
static inline BOOL EqV2(Vector2 Left, Vector2 Right)
{
    ASSERT_COVERED(EqV2);
...
COVERAGE(EqV3, 1)
static inline BOOL EqV3(Vector3 Left, Vector3 Right)
{
    ASSERT_COVERED(EqV3);
...
COVERAGE(EqV4, 1)
static inline BOOL EqV4(Vector4 Left, Vector4 Right)
{
    ASSERT_COVERED(EqV4);
...
COVERAGE(DotV2, 1)
static inline float DotV2(Vector2 Left, Vector2 Right)
{
...
COVERAGE(DotV3, 1)
static inline float DotV3(Vector3 Left, Vector3 Right)
{
...
COVERAGE(DotV4, 1)
static inline float DotV4(Vector4 Left, Vector4 Right)
{
...
COVERAGE(CrossProduct, 1)
static inline Vector3 CrossProduct(Vector3 Left, Vector3 Right)
{
    ASSERT_COVERED(CrossProduct);
...
COVERAGE(LenSqrV2, 1)
static inline float LenSqrV2(Vector2 A)
{
...
COVERAGE(LenSqrV3, 1)
static inline float LenSqrV3(Vector3 A)
{
...
COVERAGE(LenSqrV4, 1)
static inline float LenSqrV4(Vector4 A)
{
...
COVERAGE(LenV2, 1)
static inline float LenV2(Vector2 A)
{
...
COVERAGE(LenV3, 1)
static inline float LenV3(Vector3 A)
{
...
COVERAGE(LenV4, 1)
static inline float LenV4(Vector4 A)
{
...
COVERAGE(NormV2, 1)
static inline Vector2 NormV2(Vector2 A)
{
...
COVERAGE(NormV3, 1)
static inline Vector3 NormV3(Vector3 A)
{
...
COVERAGE(NormV4, 1)
static inline Vector4 NormV4(Vector4 A)
{
...
COVERAGE(LerpV2, 1)
static inline Vector2 LerpV2(Vector2 A, float Time, Vector2 B) 
{
...
COVERAGE(LerpV3, 1)
static inline Vector3 LerpV3(Vector3 A, float Time, Vector3 B) 
{
...
COVERAGE(LerpV4, 1)
static inline Vector4 LerpV4(Vector4 A, float Time, Vector4 B) 
{
...
static inline Vector4 LinearCombineV4M4(Vector4 Left, Matrix4 Right)
{
...
COVERAGE(M2D, 1)
static inline Matrix2 M2D(float Diagonal)
{
    ASSERT_COVERED(M2D);
...
static inline Matrix2 TransposeM2(Matrix2 Matrix)
{
...
COVERAGE(AddM2, 1)
static inline Matrix2 AddM2(Matrix2 Left, Matrix2 Right)
{
...
COVERAGE(SubM2, 1)
static inline Matrix2 SubM2(Matrix2 Left, Matrix2 Right)
{
...
COVERAGE(MulM2V2, 1)
static inline Vector2 MulM2V2(Matrix2 Matrix, Vector2 Vector)
{
...
COVERAGE(MulM2, 1)
static inline Matrix2 MulM2(Matrix2 Left, Matrix2 Right)
{
...
COVERAGE(MulM2F, 1)
static inline Matrix2 MulM2F(Matrix2 Matrix, float Scalar)
{
...
COVERAGE(DivM2F, 1)
static inline Matrix2 DivM2F(Matrix2 Matrix, float Scalar)
{
...
static inline float DeterminantM2(Matrix2 Matrix) 
{
...
static inline Matrix2 InvGeneralM2(Matrix2 Matrix) 
{
...
COVERAGE(M3D, 1)
static inline Matrix3 M3D(float Diagonal)
{
    ASSERT_COVERED(M3D);
...
static inline Matrix3 TransposeM3(Matrix3 Matrix)
{
...
COVERAGE(AddM3, 1)
static inline Matrix3 AddM3(Matrix3 Left, Matrix3 Right)
{
...
COVERAGE(SubM3, 1)
static inline Matrix3 SubM3(Matrix3 Left, Matrix3 Right)
{
...
COVERAGE(MulM3V3, 1)
static inline Vector3 MulM3V3(Matrix3 Matrix, Vector3 Vector)
{
...
COVERAGE(MulM3, 1)
static inline Matrix3 MulM3(Matrix3 Left, Matrix3 Right)
{
...
COVERAGE(MulM3F, 1)
static inline Matrix3 MulM3F(Matrix3 Matrix, float Scalar)
{
...
COVERAGE(DivM3, 1)
static inline Matrix3 DivM3F(Matrix3 Matrix, float Scalar)
{
...
static inline float DeterminantM3(Matrix3 Matrix) 
{
    ASSERT_COVERED(DeterminantM3);

    Matrix3 Cross;
    Cross.Columns[0] = CrossProduct(Matrix.Columns[1], Matrix.Columns[2]);
    Cross.Columns[1] = CrossProduct(Matrix.Columns[2], Matrix.Columns[0]);
    Cross.Columns[2] = CrossProduct(Matrix.Columns[0], Matrix.Columns[1]);

    return DotV3(Cross.Columns[2], Matrix.Columns[2]);
}

COVERAGE(InvGeneralM3, 1)
static inline Matrix3 InvGeneralM3(Matrix3 Matrix) 
{
...
COVERAGE(M4D, 1)
static inline Matrix4 M4D(float Diagonal)
{
    ASSERT_COVERED(M4D);
...
static inline Matrix4 TransposeM4(Matrix4 Matrix)
{
...
COVERAGE(AddM4, 1)
static inline Matrix4 AddM4(Matrix4 Left, Matrix4 Right)
{
...
COVERAGE(SubM4, 1)
static inline Matrix4 SubM4(Matrix4 Left, Matrix4 Right)
{
...
COVERAGE(MulM4, 1)
static inline Matrix4 MulM4(Matrix4 Left, Matrix4 Right)
{
...
COVERAGE(MulM4F, 1)
static inline Matrix4 MulM4F(Matrix4 Matrix, float Scalar)
{
...
COVERAGE(MulM4V4, 1)
static inline Vector4 MulM4V4(Matrix4 Matrix, Vector4 Vector)
{
...
COVERAGE(DivM4F, 1)
static inline Matrix4 DivM4F(Matrix4 Matrix, float Scalar)
{
...
static inline float DeterminantM4(Matrix4 Matrix) 
{
    ASSERT_COVERED(DeterminantM4);

    Vector3 C01 = CrossProduct(Matrix.Columns[0].XYZ, Matrix.Columns[1].XYZ);
    Vector3 C23 = CrossProduct(Matrix.Columns[2].XYZ, Matrix.Columns[3].XYZ);
    Vector3 B10 = SubV3(MulV3F(Matrix.Columns[0].XYZ, Matrix.Columns[1].W), MulV3F(Matrix.Columns[1].XYZ, Matrix.Columns[0].W));
    Vector3 B32 = SubV3(MulV3F(Matrix.Columns[2].XYZ, Matrix.Columns[3].W), MulV3F(Matrix.Columns[3].XYZ, Matrix.Columns[2].W));
...
static inline Matrix4 InvGeneralM4(Matrix4 Matrix) 
{
    ...
    Matrix4 Result;
    Result.Columns[0] = V4V(AddV3(CrossProduct(Matrix.Columns[1].XYZ, B32), MulV3F(C23, Matrix.Columns[1].W)), -DotV3(Matrix.Columns[1].XYZ, C23));
    Result.Columns[1] = V4V(SubV3(CrossProduct(B32, Matrix.Columns[0].XYZ), MulV3F(C23, Matrix.Columns[0].W)), +DotV3(Matrix.Columns[0].XYZ, C23));
    Result.Columns[2] = V4V(AddV3(CrossProduct(Matrix.Columns[3].XYZ, B10), MulV3F(C01, Matrix.Columns[3].W)), -DotV3(Matrix.Columns[3].XYZ, C01));
    Result.Columns[3] = V4V(SubV3(CrossProduct(B10, Matrix.Columns[2].XYZ), MulV3F(C01, Matrix.Columns[2].W)), +DotV3(Matrix.Columns[2].XYZ, C01));
...
static inline Matrix4 Orthographic_RH_NO(float Left, float Right, float Bottom, float Top, float Near, float Far)
{
...
// Left, Right, Bottom, and Top specify the coordinates of their respective clipping planes.
// Near and Far specify the distances to the near and far clipping planes.
static inline Matrix4 Orthographic_RH_ZO(float Left, float Right, float Bottom, float Top, float Near, float Far)
{
...
// Left, Right, Bottom, and Top specify the coordinates of their respective clipping planes.
// Near and Far specify the distances to the near and far clipping planes.
static inline Matrix4 Orthographic_LH_NO(float Left, float Right, float Bottom, float Top, float Near, float Far)
{
    ASSERT_COVERED(Orthographic_LH_NO);

    Matrix4 Result = Orthographic_RH_NO(Left, Right, Bottom, Top, Near, Far);
...
// Left, Right, Bottom, and Top specify the coordinates of their respective clipping planes.
// Near and Far specify the distances to the near and far clipping planes.
static inline Matrix4 Orthographic_LH_ZO(float Left, float Right, float Bottom, float Top, float Near, float Far)
{
    ASSERT_COVERED(Orthographic_LH_ZO);

    Matrix4 Result = Orthographic_RH_ZO(Left, Right, Bottom, Top, Near, Far);
    Result.Elements[2][2] = -Result.Elements[2][2];
...
static inline Matrix4 InvOrthographic(Matrix4 OrthoMatrix)
{
...
static inline Matrix4 Perspective_RH_NO(float FOV, float AspectRatio, float Near, float Far)
{
...
static inline Matrix4 Perspective_RH_ZO(float FOV, float AspectRatio, float Near, float Far)
{
...
static inline Matrix4 Perspective_LH_NO(float FOV, float AspectRatio, float Near, float Far)
{ 
...
static inline Matrix4 Perspective_LH_ZO(float FOV, float AspectRatio, float Near, float Far)
{ 
...
static inline Matrix4 InvPerspective_RH(Matrix4 PerspectiveMatrix)
{
...
static inline Matrix4 InvPerspective_LH(Matrix4 PerspectiveMatrix)
{
...
static inline Matrix4 Translate(Vector3 Translation)
{
    ASSERT_COVERED(Translate);

    Matrix4 Result = M4D(1.0f);
...
static inline Matrix4 InvTranslate(Matrix4 TranslationMatrix)
{
...
static inline Matrix4 Rotate_RH(float Angle, Vector3 Axis)
{
...
static inline Matrix4 Rotate_LH(float Angle, Vector3 Axis)
{
...
static inline Matrix4 InvRotate(Matrix4 RotationMatrix)
{
...
COVERAGE(Scale, 1)
static inline Matrix4 Scale(Vector3 Scale)
{
...
COVERAGE(InvScale, 1)
static inline Matrix4 InvScale(Matrix4 ScaleMatrix) 
{
...
static inline Matrix4 _LookAt(Vector3 F,  Vector3 S, Vector3 U,  Vector3 Eye)
{
    Matrix4 Result;
...
static inline Matrix4 LookAt_RH(Vector3 Eye, Vector3 Center, Vector3 Up)
{
    ASSERT_COVERED(LookAt_RH);

    Vector3 F = NormV3(SubV3(Center, Eye));
    Vector3 S = NormV3(CrossProduct(F, Up));
...
static inline Matrix4 LookAt_LH(Vector3 Eye, Vector3 Center, Vector3 Up)
{
    ASSERT_COVERED(LookAt_LH);

    Vector3 F = NormV3(SubV3(Eye, Center));
    Vector3 S = NormV3(CrossProduct(F, Up));
    Vector3 U = CrossProduct(S, F);
...
static inline Matrix4 InvLookAt(Matrix4 Matrix)
{
...
COVERAGE(Quat, 1)
static inline Quaternion Quat(float X, float Y, float Z, float W)
{
    ASSERT_COVERED(Quat);
...
COVERAGE(QV4, 1)
static inline Quaternion QV4(Vector4 Vector)
{
    ASSERT_COVERED(QV4);
...
COVERAGE(AddQ, 1)
static inline Quaternion AddQ(Quaternion Left, Quaternion Right)
{
    ASSERT_COVERED(AddQ);
...
COVERAGE(SubQ, 1)
static inline Quaternion SubQ(Quaternion Left, Quaternion Right)
{
    ASSERT_COVERED(SubQ);
...
COVERAGE(MulQ, 1)
static inline Quaternion MulQ(Quaternion Left, Quaternion Right)
{
    ASSERT_COVERED(MulQ);
...
COVERAGE(MulQF, 1)
static inline Quaternion MulQF(Quaternion Left, float Multiplicative)
{
...
COVERAGE(DivQF, 1)
static inline Quaternion DivQF(Quaternion Left, float Divnd)
{
...
COVERAGE(DotQ, 1)
static inline float DotQ(Quaternion Left, Quaternion Right)
{
    ASSERT_COVERED(DotQ);
...
COVERAGE(InvQ, 1)
static inline Quaternion InvQ(Quaternion Left)
{
    ASSERT_COVERED(InvQ);
...
COVERAGE(NormQ, 1)
static inline Quaternion NormQ(Quaternion Quat)
{
    ASSERT_COVERED(NormQ);

    /* NOTE(lcf): Take advantage of SSE implementation in NormV4 */
    Vector4 Vec = {Quat.X, Quat.Y, Quat.Z, Quat.W};
    Vec = NormV4(Vec);
    Quaternion Result = {Vec.X, Vec.Y, Vec.Z, Vec.W};

    return Result;
}

static inline Quaternion _MixQ(Quaternion Left, float MixLeft, Quaternion Right, float MixRight) {
    Quaternion Result;
...
COVERAGE(NLerp, 1)
static inline Quaternion NLerp(Quaternion Left, float Time, Quaternion Right)
{
    ASSERT_COVERED(NLerp);

    Quaternion Result = _MixQ(Left, 1.0f-Time, Right, Time);
    Result = NormQ(Result);
...
COVERAGE(SLerp, 1)
static inline Quaternion SLerp(Quaternion Left, float Time, Quaternion Right)
{
...
COVERAGE(QToM4, 1)
static inline Matrix4 QToM4(Quaternion Left)
{
    ASSERT_COVERED(QToM4);

    Matrix4 Result;

    Quaternion NormalizedQ = NormQ(Left);
...
// comment. :)
COVERAGE(M4ToQ_RH, 4)
static inline Quaternion M4ToQ_RH(Matrix4 M)
{
    float T;
    Quaternion Q;
...
COVERAGE(M4ToQ_LH, 4)
static inline Quaternion M4ToQ_LH(Matrix4 M)
{
    float T;
    Quaternion Q;
...
static inline Quaternion QFromAxisAngle_RH(Vector3 Axis, float AngleOfRotation)
{
    ASSERT_COVERED(QFromAxisAngle_RH);

    Quaternion Result;

    Vector3 AxisNormalized = NormV3(Axis);
...
static inline Quaternion QFromAxisAngle_LH(Vector3 Axis, float AngleOfRotation)
{
...
COVERAGE(LenV2CPP, 1)
static inline float Len(Vector2 A)
{
...
COVERAGE(LenV3CPP, 1)
static inline float Len(Vector3 A)
{
...
COVERAGE(LenV4CPP, 1)
static inline float Len(Vector4 A)
{
...
static inline float LenSqr(Vector2 A)
{
...
static inline float LenSqr(Vector3 A)
{
...
static inline float LenSqr(Vector4 A)
{
...
static inline Vector2 Norm(Vector2 A)
{
...
static inline Vector3 Norm(Vector3 A)
{
...
static inline Vector4 Norm(Vector4 A)
{
...
COVERAGE(NormQCPP, 1)
static inline Quaternion Norm(Quaternion A)
{
...
COVERAGE(DotV2CPP, 1)
static inline float Dot(Vector2 Left, Vector2 VecTwo)
{
...
COVERAGE(DotV3CPP, 1)
static inline float Dot(Vector3 Left, Vector3 VecTwo)
{
...
COVERAGE(DotV4CPP, 1)
static inline float Dot(Vector4 Left, Vector4 VecTwo)
{
...
static inline Vector2 Lerp(Vector2 Left, float Time, Vector2 Right) 
{
...
static inline Vector3 Lerp(Vector3 Left, float Time, Vector3 Right) 
{
...
static inline Vector4 Lerp(Vector4 Left, float Time, Vector4 Right) 
{
...
static inline Matrix2 Transpose(Matrix2 Matrix)
{
...
static inline Matrix3 Transpose(Matrix3 Matrix)
{
...
static inline Matrix4 Transpose(Matrix4 Matrix)
{
...
static inline float Determinant(Matrix2 Matrix)
{
...
static inline float Determinant(Matrix3 Matrix)
{
...
static inline float Determinant(Matrix4 Matrix)
{
...
static inline Matrix2 InvGeneral(Matrix2 Matrix)
{
...
static inline Matrix3 InvGeneral(Matrix3 Matrix)
{
...
static inline Matrix4 InvGeneral(Matrix4 Matrix)
{
...
COVERAGE(DotQCPP, 1)
static inline float Dot(Quaternion QuatOne, Quaternion QuatTwo)
{
...
COVERAGE(AddV2CPP, 1)
static inline Vector2 Add(Vector2 Left, Vector2 Right)
{
...
COVERAGE(AddV3CPP, 1)
static inline Vector3 Add(Vector3 Left, Vector3 Right)
{
...
COVERAGE(AddV4CPP, 1)
static inline Vector4 Add(Vector4 Left, Vector4 Right)
{
...
COVERAGE(AddM2CPP, 1)
static inline Matrix2 Add(Matrix2 Left, Matrix2 Right)
{
...
COVERAGE(AddM3CPP, 1)
static inline Matrix3 Add(Matrix3 Left, Matrix3 Right)
{
...
COVERAGE(AddM4CPP, 1)
static inline Matrix4 Add(Matrix4 Left, Matrix4 Right)
{
...
COVERAGE(AddQCPP, 1)
static inline Quaternion Add(Quaternion Left, Quaternion Right)
{
...
COVERAGE(SubV2CPP, 1)
static inline Vector2 Sub(Vector2 Left, Vector2 Right)
{
...
COVERAGE(SubV3CPP, 1)
static inline Vector3 Sub(Vector3 Left, Vector3 Right)
{
...
COVERAGE(SubV4CPP, 1)
static inline Vector4 Sub(Vector4 Left, Vector4 Right)
{
...
COVERAGE(SubM2CPP, 1)
static inline Matrix2 Sub(Matrix2 Left, Matrix2 Right)
{
...
COVERAGE(SubM3CPP, 1)
static inline Matrix3 Sub(Matrix3 Left, Matrix3 Right)
{
...
COVERAGE(SubM4CPP, 1)
static inline Matrix4 Sub(Matrix4 Left, Matrix4 Right)
{
...
COVERAGE(SubQCPP, 1)
static inline Quaternion Sub(Quaternion Left, Quaternion Right)
{
...
COVERAGE(MulV2CPP, 1)
static inline Vector2 Mul(Vector2 Left, Vector2 Right)
{
...
static inline Vector2 Mul(Vector2 Left, float Right)
{
...
COVERAGE(MulV3CPP, 1)
static inline Vector3 Mul(Vector3 Left, Vector3 Right)
{
...
static inline Vector3 Mul(Vector3 Left, float Right)
{
...
COVERAGE(MulV4CPP, 1)
static inline Vector4 Mul(Vector4 Left, Vector4 Right)
{
...
static inline Vector4 Mul(Vector4 Left, float Right)
{
...
COVERAGE(MulM2CPP, 1)
static inline Matrix2 Mul(Matrix2 Left, Matrix2 Right)
{
...
COVERAGE(MulM3CPP, 1)
static inline Matrix3 Mul(Matrix3 Left, Matrix3 Right)
{
...
COVERAGE(MulM4CPP, 1)
static inline Matrix4 Mul(Matrix4 Left, Matrix4 Right)
{
...
static inline Matrix2 Mul(Matrix2 Left, float Right)
{
...
static inline Matrix3 Mul(Matrix3 Left, float Right)
{
...
static inline Matrix4 Mul(Matrix4 Left, float Right)
{
...
static inline Vector2 Mul(Matrix2 Matrix, Vector2 Vector)
{
...
static inline Vector3 Mul(Matrix3 Matrix, Vector3 Vector)
{
...
static inline Vector4 Mul(Matrix4 Matrix, Vector4 Vector)
{
...
COVERAGE(MulQCPP, 1)
static inline Quaternion Mul(Quaternion Left, Quaternion Right)
{
...
COVERAGE(MulQFCPP, 1)
static inline Quaternion Mul(Quaternion Left, float Right)
{
...
COVERAGE(DivV2CPP, 1)
static inline Vector2 Div(Vector2 Left, Vector2 Right)
{
...
static inline Vector2 Div(Vector2 Left, float Right)
{
...
COVERAGE(DivV3CPP, 1)
static inline Vector3 Div(Vector3 Left, Vector3 Right)
{
...
static inline Vector3 Div(Vector3 Left, float Right)
{
...
COVERAGE(DivV4CPP, 1)
static inline Vector4 Div(Vector4 Left, Vector4 Right)
{
...
static inline Vector4 Div(Vector4 Left, float Right)
{
...
static inline Matrix2 Div(Matrix2 Left, float Right)
{
...
static inline Matrix3 Div(Matrix3 Left, float Right)
{
...
static inline Matrix4 Div(Matrix4 Left, float Right)
{
...
COVERAGE(DivQFCPP, 1)
static inline Quaternion Div(Quaternion Left, float Right)
{
...
COVERAGE(EqV2CPP, 1)
static inline BOOL Eq(Vector2 Left, Vector2 Right)
{
...
COVERAGE(EqV3CPP, 1)
static inline BOOL Eq(Vector3 Left, Vector3 Right)
{
...
COVERAGE(EqV4CPP, 1)
static inline BOOL Eq(Vector4 Left, Vector4 Right)
{
...
COVERAGE(AddV4Op, 1)
static inline Vector4 operator+(Vector4 Left, Vector4 Right)
{
...
COVERAGE(AddM2Op, 1)
static inline Matrix2 operator+(Matrix2 Left, Matrix2 Right)
{
...
COVERAGE(AddM3Op, 1)
static inline Matrix3 operator+(Matrix3 Left, Matrix3 Right)
{
...
COVERAGE(AddM4Op, 1)
static inline Matrix4 operator+(Matrix4 Left, Matrix4 Right)
{
...
COVERAGE(AddQOp, 1)
static inline Quaternion operator+(Quaternion Left, Quaternion Right)
{
...
COVERAGE(MulV2FOp, 1)
static inline Vector2 operator*(Vector2 Left, float Right)
{
...
COVERAGE(MulV3FOp, 1)
static inline Vector3 operator*(Vector3 Left, float Right)
{
...
COVERAGE(MulV4FOp, 1)
static inline Vector4 operator*(Vector4 Left, float Right)
{
...
COVERAGE(MulM2FOp, 1)
static inline Matrix2 operator*(Matrix2 Left, float Right)
{
...
COVERAGE(MulM3FOp, 1)
static inline Matrix3 operator*(Matrix3 Left, float Right)
{
...
COVERAGE(MulM4FOp, 1)
static inline Matrix4 operator*(Matrix4 Left, float Right)
{
...
COVERAGE(MulQFOp, 1)
static inline Quaternion operator*(Quaternion Left, float Right)
{
...
static inline Vector2 operator*(float Left, Vector2 Right)
{
...
static inline Vector3 operator*(float Left, Vector3 Right)
{
...
static inline Vector4 operator*(float Left, Vector4 Right)
{
...
static inline Matrix2 operator*(float Left, Matrix2 Right)
{
...
static inline Matrix3 operator*(float Left, Matrix3 Right)
{
...
static inline Matrix4 operator*(float Left, Matrix4 Right)
{
...
static inline Quaternion operator*(float Left, Quaternion Right)
{
...
static inline Vector2 operator*(Matrix2 Matrix, Vector2 Vector)
{
...
static inline Vector3 operator*(Matrix3 Matrix, Vector3 Vector)
{
...
static inline Vector4 operator*(Matrix4 Matrix, Vector4 Vector)
{
...
COVERAGE(EqV2Op, 1)
static inline BOOL operator==(Vector2 Left, Vector2 Right)
{
...
COVERAGE(EqV3Op, 1)
static inline BOOL operator==(Vector3 Left, Vector3 Right)
{
...
COVERAGE(EqV4Op, 1)
static inline BOOL operator==(Vector4 Left, Vector4 Right)
{
...
static inline Vector2 operator-(Vector2 In)
{
...
static inline Vector3 operator-(Vector3 In)
{
...
static inline Vector4 operator-(Vector4 In)
{
...
#define Determinant(M) _Generic((M), \
        Matrix2: DeterminantM2, \
        Matrix3: DeterminantM3, \
        Matrix4: DeterminantM4  \
)(M)

#define InvGeneral(M) _Generic((M), \
        Matrix2: InvGeneralM2, \
        Matrix3: InvGeneralM3, \
        Matrix4: InvGeneralM4  \
)(M)
